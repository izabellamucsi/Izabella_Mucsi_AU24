 ...
 * Solution: The query filters the data to include only the specified years, product categories, and distribution channels in order to calculate the cumulative sum of sales by quarter and the total sales for each product category for each quarter.
